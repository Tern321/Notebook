#pragma checksum "D:\Dropbox\program\typescript\Forum\Forum\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "690d095ee21da0d6904195d6e99a85c2009162d4"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"690d095ee21da0d6904195d6e99a85c2009162d4", @"/Views/Home/Index.cshtml")]
        ...
        <div class=""uiButtons"">
            ...
            <div>
                <div>
                    <div>
                        ...
                        <button class=""UIBbutton"" onclick=""Cont");
            WriteLiteral(@"roller.addContention()"" id='addButton'>Добавить</button>
                        <button class=""UIBbutton"" onclick=""Controller.changeContention()"" id='changeButton'>Изменить</button>
                        <button class=""UIBbutton"" onclick=""Controller.createTopicFromContention()"" style=""background-color: #e6e6e6;"">Топик</button>
                        <button class=""UIBbutton""");
            BeginWriteAttribute("onclick", " onclick=\"", 1453, "\"", 1463, 0);
            EndWriteAttribute();
            WriteLiteral(@">перенести</button>
                    ...
                    <div>
                        ...
                        <button class=""UIBbutton"" onclick=""Controller.addLink()"">Link</button>
                        <button class=""UIBbutton"" onclick=""Controller.deleteContention()"">удалить</button>
                        <button class=""UIBbutton"" onclick=""Controller.addSelectedToArchive()"">(archive)");
            WriteLiteral(@"</button>
                        <button class=""UIBbutton"" onclick=""Controller.collapceSelectedContention()"" style=""background-color: #9b9bff;"">свернуть</button>
