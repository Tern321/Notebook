...
class CryptoWarper {
    ...
    */
    ...
    static bytesArrToBase64(arr: Uint8Array)
    {
    ...
    static Int8toBase64(u8: Uint8Array):string {
        return btoa(String.fromCharCode.apply(null, u8));
    }

    static Base64ToInt8(b64encoded: string): Uint8Array {
    ...
    static async encrypt(password: string, json:string): Promise<EncryptionData> {
        var data: EncryptionData = new EncryptionData();
    ...
    */
    static async decrypt(password: string, data: EncryptionData): Promise<string> {
