class BranchPageActionsController {
    ...
    static addContentionOrUrl() {
        var textArea = BranchPageController.argumentTextArea();
    ...
    static archiveForContention(contentionId) {
        var cn = BranchPageController.selectedBranch().contentionForId(contentionId);
    ...
    static changeContention() {
        var selectedcontention = BranchPageController.selectedContention();
        var textArea = BranchPageController.argumentTextArea();
    ...
    static addToArchive(contentionId) {
        var cn = BranchPageController.selectedBranch().contentionsMap.get(contentionId);
...
//# sourceMappingURL=BranchPageActionsController.js.map